...
This document provides guidelines for internationalization of the Bayemcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bayemcoin_en.ts` remains unchanged.
