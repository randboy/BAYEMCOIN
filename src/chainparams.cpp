...
// Copyright (c) 2009-2016 The Ravencoin Core developers
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1598230720, 38638, 0x1e00ffff, 2, 500 * COIN);

        consensus.hashGenesisBlock = genesis.GetHash();
        //std::cout << consensus.hashGenesisBlock.GetHex() << "\n";
        //std::cout << "Merkle: " << genesis.hashMerkleRoot.GetHex() << "\n";

        assert(consensus.hashGenesisBlock == uint256S("0x000000752b6b52f0d150e0725f470191a53b2d5b865c9305b8d3aff8ebce1826"));
        assert(genesis.hashMerkleRoot == uint256S("0x21c6e0b7872768c4b0c0ac4ab8422ea3e06f8fbe0e600f93e428f3c6715b0a55"));
        ...
        chainTxData = ChainTxData{
            // Update as we know more about the contents of the Bayemcoin chain
            1598230720, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 2 * 60 * 60; // 1.4 days
        consensus.nPowTargetSpacing = 1 * 60;
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 80; // 75% for testchains
        consensus.nMinerConfirmationWindow = 120; // nPowTargetTimespan / nPowTargetSpacing
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].bit = 28;
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nStartTime = 1199145601; // January 1, 2008
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 1230767999; // December 31, 2008
