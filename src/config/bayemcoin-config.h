/* src/config/bayemcoin-config.h.  Generated from bayemcoin-config.h.in by configure.  */
/* src/config/bayemcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BAYEMCOIN_CONFIG_H

#define BAYEMCOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Bayemcoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Bayemcoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/BayemcoinProject/Bayemcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Bayemcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bayemcoin Core 0.15.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bayemcoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://bayemcoin.org/"
