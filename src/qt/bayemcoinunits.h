...
#ifndef BAYEMCOIN_QT_BAYEMCOINUNITS_H
#define BAYEMCOIN_QT_BAYEMCOINUNITS_H
...
/** Bayemcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BayemcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BayemcoinUnits(QObject *parent);

    /** Bayemcoin units.
      @note Source: https://en.bayemcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BYM,
...
typedef BayemcoinUnits::Unit BayemcoinUnit;

#endif // BAYEMCOIN_QT_BAYEMCOINUNITS_H
