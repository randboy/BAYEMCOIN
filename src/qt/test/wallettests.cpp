...
#include "qt/bayemcoinamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<BayemcoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_bayemcoin-qt -platform xcb      # Linux
//     src/qt/test/test_bayemcoin-qt -platform windows  # Windows
//     src/qt/test/test_bayemcoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = BayemcoinUnits::formatWithUnit(unit, balance, false, BayemcoinUnits::separatorAlways);
    ...
    // Amount input
    BayemcoinAmountField* amountInput = receiveCoinsDialog.findChild<BayemcoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: bayemcoin:")) != -1);
