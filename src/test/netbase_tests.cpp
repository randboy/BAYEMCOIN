...
{
    BOOST_CHECK(TestSplitHost("www.bayemcoin.org", "www.bayemcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bayemcoin.org]", "www.bayemcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.bayemcoin.org:80", "www.bayemcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bayemcoin.org]:80", "www.bayemcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:4979", "127.0.0.1", 8767));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:4979", "127.0.0.1", 8767));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:4979", "::ffff:127.0.0.1", 8767));
    BOOST_CHECK(TestSplitHost("[::]:4979", "::", 8767));
    BOOST_CHECK(TestSplitHost("::4979", "::8767", -1));
    BOOST_CHECK(TestSplitHost(":4979", "", 8767));
    BOOST_CHECK(TestSplitHost("[]:4979", "", 8767));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:4979", "127.0.0.1:8767"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:4979", "[::]:8767"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
