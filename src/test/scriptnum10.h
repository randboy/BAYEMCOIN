...
#ifndef BAYEMCOIN_TEST_SCRIPTNUM10_H
#define BAYEMCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bayemcoin Core 0.10.0, for cross-comparison.
 */
public:
