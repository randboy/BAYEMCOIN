...
#ifndef BAYEMCOIN_WALLET_WALLET_H
#define BAYEMCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this bayemcoin node, and set to 0 for transactions that were created
...
#endif // BAYEMCOIN_WALLET_WALLET_H
