...
class TestBayemcoinCli(BayemcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from `bayemcoin-cli -getinfo` and the RPCs data is retrieved from.")
