...
class BIP66Test(BayemcoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # bayemcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and bayemcoind produces more specific reject
            # reasons.
