...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BayemcoinTestFramework
    pass

class ExampleTest(BayemcoinTestFramework):
    # Each functional test is a subclass of the BayemcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        BayemcoinTestFramework class so other tests can use it."""
