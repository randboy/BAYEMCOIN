...
By default, bayemcoind will dump mempool on shutdown and
...
class MempoolPersistTest(BayemcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give bayemcoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent bayemcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
