...
# TestNode: A peer we use to send messages to bayemcoind, and store responses.
...
class CompactBlocksTest(BayemcoinTestFramework):
    ...
    # This test actually causes bayemcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that bayemcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bayemcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bayemcoind will not send blocktxn responses for blocks whose height is
