...
class TxnMallTest(BayemcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 BYM:
        ...
        # First: use raw transaction API to send 1240 BYM to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 BYM coin each
        ...
        # Node0's balance should be starting balance, plus 50BYM for another
        ...
        # Node0's total balance should be starting balance, plus 100BYM for 
