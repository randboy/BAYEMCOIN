...
class WalletTest(BayemcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 BYM from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 BYM with subtract fee from amount
        ...
        # Sendmany 10 BYM with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/BayemcoinProject/Bayemcoin/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
